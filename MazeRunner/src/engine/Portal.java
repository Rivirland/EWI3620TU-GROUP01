...
public class Portal {
	...
	public static void activePortaldisplay(GL gl) {
		...
		if (mazeID != -1) {
			...
			// TODO tijdelijk om te testen, nu worden ook de portals die
			// gestencild worden hier weergegeven,
			// deze functie wordt later aangeroepen om alleen de inactieve
			// portals weer te geven
	...
	public static void portalView(GL gl, Camera portalcamera) {
		...
		GLU glu = new GLU();
		GLUT glut = new GLUT();
		// // gl.glViewport(0, 0, MazeRunner.getScreenWidth(),
		// MazeRunner.getScreenHeight());
		// gl.glLoadIdentity();
